...
using Microservices.Demo.Product.API.CQRS.Queries.FindListProducts;
...
namespace Microservices.Demo.Product.API.Application
{
    public class ProductApplicationService
    {
        ...
        public async Task<IEnumerable<ProductDto>> GetByProductCodeListAsync(List<string> productCodeList)
        {
            var products = await _mediator.Send(new FindListProductsQuery { ProductCodeList = productCodeList });
            return products;
        }
