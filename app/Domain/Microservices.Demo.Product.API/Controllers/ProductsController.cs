...
namespace Microservices.Demo.Product.API.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        [HttpPost("list")]
        public async Task<ActionResult> PostByProductCodeList([FromBody] List<string> query)
        {
            return new JsonResult(await _productApplicationService.GetByProductCodeListAsync(query));
        }
